...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './WhiteDevil.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ ʙʟᴀᴄᴋ ʙᴏᴛ*' : process.env.ALL_CAPTION,
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://www.linkpicture.com/q/IMG-20220108-WA0143.jpg' : process.env.ALIVE_LOGO,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'ʙʟᴀᴄᴋ ʙᴏᴛ' : process.env.BOT_NAME,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    BOT1: process.env.BOT_NAMES === undefined ? 'ʙʟᴀᴄᴋ ʙᴏᴛ' : process.env.BOT_NAMES,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'ʙʟᴀᴄᴋ ʙᴏᴛ' : process.env.BOT_NAME,
